...
legend('mērījumi','grafiks')
grid
%% Secinājumi
% šos mērījumu rezultātus ar polyfit un polyval funkcijām 
% nevar precīzi attēlot un šie grafiki ir ļoti neprecīzi
% varētu precīzāk attēlot grafikus ja būtu vairāk mērījumu
%% izmantoju GREEN grafiku
%%
%
% <<../grafiks.png>>
%
